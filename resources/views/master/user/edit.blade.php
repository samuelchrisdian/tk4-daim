                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-7 col-lg-10">
                        <div class="mx-sm-30 mx-20 ">
                            ...
                            @endif
                            <!-- Start: card -->
                            <div class="card add-user p-sm-30 p-20 mb-30">
                                <div class="card-body p-0">
                                    <div class="card-header">
                                        <h6 class="fw-500">Edit User</h6>
                                    </div>
                                    <!-- Start: card body -->
                                    <div class="add-product__body px-sm-40 px-20">
                                        <!-- Start: form -->
                                        <form method="POST" action="{{ route('master-user-update', $user->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="name">user name</label>
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="input user name..." value="{{ $user->name }}" required>
                                                @error('name')
                                            ...
                                            <div class="form-group mb-20">
                                                ...
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="name@example.com" name="email" value="{{ $user->email }}" required autocomplete="email">
                                                @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group mb-20">
                                                ...
                                                <select class="custom-select form-control select-arrow-none ih-medium radius-xs b-light shadow-none color-light fs-14 @error('role_id') is-invalid @enderror" id="role_id" name="role_id" aria-describedby="role_id" required>
                                                    ...
                                                    @endphp
                                                    <option value="{{ $value->role_id }}" {{ $check }}>{{ $value->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('role_id')
                                                <div class="invalid-feedback">
                            ...
                            <!-- Start: button group -->
                            <div class="button-group add-user-btn d-flex justify-content-sm-end justify-content-center mt-40">
