                        ...
                        <div class="table-responsive">
                            <div class="adv-table-table__header mb-4">
                                ...
                                <div class="adv-table-table__button">
                                    <a href="{{ route('master-user-add') }}" class="btn px-15 btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                <li>
                                                    <a href="{{ route('master-user-show', $value->id) }}" class="view">
                                                        <i class="uil uil-eye"></i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('master-user-edit', $value->id) }}" class="edit">
                                                        <i class="uil uil-edit"></i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a type="button" class="remove" id="delete-user" data-bs-toggle="modal" data-bs-target="#modal-delete" data-id="{{ $value->id }}" data-name="{{ $value->name }}">
...
<div class="modal-reset modal fade show" id="modal-reset" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-info" role="document">
        <div class="modal-content">
            <form method="POST" id="modal-reset-form" action="">
                @csrf
                <div class="modal-body">
                    <div class="modal-info-body d-flex">
                        <div class="modal-info-icon warning">
                        ...
                        <div class="modal-info-text">
                            <h6>Do you Want to reset these item?</h6>
                            <p id="modal-reset-description"></p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    $(document).on("click", "#activate-user", function() {
        ...
        let url = "{{ route('master-user-activate', ':id') }}";
    ...
    $(document).on("click", "#deactivate-user", function() {
        ...
        let url = "{{ route('master-user-deactivate', ':id') }}";
        url = url.replace(':id', id);
    ...
    $(document).on("click", "#reset-user", function() {
        ...
        let url = "{{ route('master-user-reset', ':id') }}";
        url = url.replace(':id', id);

        $('#modal-reset-description').html(name);
    ...
    $(document).on("click", "#delete-user", function() {
        ...
        let url = "{{ route('master-user-delete', ':id') }}";
        url = url.replace(':id', id);
