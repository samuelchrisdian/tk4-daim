                        ...
                        <div class="table-responsive">
                            <div class="adv-table-table__header mb-4">
                                ...
                                <div class="adv-table-table__button">
                                    <a href="{{ route('master-item-add') }}" class="btn px-15 btn-primary">
                                        <i class="las la-plus fs-16"></i>Create Item</a>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                <li>
                                                    <a href="{{ route('master-item-show', $value->item_id) }}" class="view">
                                                        <i class="uil uil-eye"></i>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('master-item-edit', $value->item_id) }}" class="edit">
...
<script>
    ...
    $(document).on("click", "#activate-item", function() {
        ...
        let url = "{{ route('master-item-activate', ':id') }}";
    ...
    $(document).on("click", "#deactivate-item", function() {
        ...
        let url = "{{ route('master-item-deactivate', ':id') }}";
        url = url.replace(':id', id);
    ...
    $(document).on("click", "#delete-item", function() {
        ...
        let url = "{{ route('master-item-delete', ':id') }}";
        url = url.replace(':id', id);
