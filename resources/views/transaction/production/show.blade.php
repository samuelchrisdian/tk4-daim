        ...
        <div class="col-lg-12">
            <div class="shop-breadcrumb">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Production Details</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Production Details</li>
                            </ol>
                        </nav>
                    </div>
                </div>
